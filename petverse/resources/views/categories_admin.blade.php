...
<head>
    ...
    <title>Categories - Pet Animixon Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('categories.admin') }}" class="nav-item active" data-page="categories">
        ...
        <main class="main-content">
            <div class="content-header">
                ...
                <div class="date-filter">
                    <button type="button" class="btn-secondary">Reorder Categories</button>
                    <button type="button" class="btn-primary">+ Add Category</button>
                </div>
            </div>
