...
<head>
    ...
    <title>Products - Pet Animixon Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('products.admin') }}" class="nav-item active" data-page="products">
        ...
        <main class="main-content">
            <div class="content-header">
                ...
                <div class="date-filter">
                    <select id="productsDateRange" class="filter-select" aria-label="Date range">
                        <option value="30">Last 30 days</option>
                        <option value="7">Last 7 days</option>
                        <option value="90">Last 90 days</option>
                    </select>
                    <button type="button" class="btn-primary">+ Add New Product</button>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr data-status="{{ $product->product_status ?? 'active' }}">
                                ...
                                <td class="col-actions">
                                    <a href="#" class="action-btn" title="Edit" aria-label="Edit product">
