...
<body>
    <div class="admin-page">
        <div class="admin-header">
            <div class="admin-logo" style="display:flex; align-items:center; justify-content:center; gap:12px; margin-bottom:20px;">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="max-height: 48px;">
...
</html><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/admin_login.blade.php ENDPATH**/ ?>