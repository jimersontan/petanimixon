    ...
    <div class="form-panel-left">
                ...
                <div style="flex: 1;">
                    <select name="animal_type_id" id="animal_type_id" class="form-control select2-animal" required>
                        ...
                        <?php $__currentLoopData = $animal_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $at): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($at->id); ?>" <?php echo e((old('animal_type_id', $product->animal_type_id ?? '') == $at->id) ? 'selected' : ''); ?>><?php echo e($at->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="form-row" style="display: flex; gap: 15px;">
            ...
            <div class="form-group" style="flex: 1;">
                ...
                <input type="number" min="0" name="stock" id="stock" class="form-control" value="<?php echo e(old('stock', $product->stock ?? '')); ?>">
            </div>
            <!-- End: Stock -->
        </div>
            ...
            <div class="image-upload-wrapper">
                ...
                <?php if(!empty($product->animal_image_url)): ?>
                    <div class="image-preview mt-2">
                        <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->product_name); ?> image" style="max-height: 100px; border-radius: 8px; border: 1px solid #e5e7eb; padding: 4px;">
                    </div>
                <?php endif; ?>
                <!-- End: Image Preview -->
            </div>
...
<?php $__env->stopPush(); ?>
<!-- ===== END JAVASCRIPT ===== -->
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/products/_form.blade.php ENDPATH**/ ?>