...
<div class="mo-page">
    ...
    <div class="mo-stats">
        ...
        <div class="mo-stat-card">
            ...
            <div>
                <div class="mo-stat-num"><?php echo e($stats['shipped'] ?? 0); ?></div>
    ...
    <div class="mo-tabs">
        ...
        <a href="<?php echo e(route('orders', ['status' => 'shipped'])); ?>" class="mo-tab <?php echo e($sf === 'shipped' ? 'active' : ''); ?>">
            Shipped <span class="mo-tab-count"><?php echo e($stats['shipped'] ?? 0); ?></span>
        </a>
                ...
                <div class="mo-order-card">
                        ...
                        <?php $__currentLoopData = $order->orderItems->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mo-product-item">
                                ...
                                <div>
                                    ...
                                    <div class="mo-product-qty">x<?php echo e($item->quantity); ?> · ₱<?php echo e(number_format($item->price ?? 0, 0)); ?></div>
                                </div>
                            </div>
                    ...
                    <div class="mo-order-bottom">
                        <div>
                            ...
                            <div class="mo-total-value">₱<?php echo e(number_format($order->total_amount, 2)); ?></div>
                        </div>
        ...
        <div class="mo-rec-section">
            ...
            <div class="mo-rec-grid">
                <?php $__currentLoopData = $recommendedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('product.show', $product->id)); ?>" class="mo-rec-card">
                        ...
                        <div class="mo-rec-body">
                            ...
                            <div class="mo-rec-price">₱<?php echo e(number_format($product->price, 0)); ?></div>
                        </div>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/frontend/orders.blade.php ENDPATH**/ ?>