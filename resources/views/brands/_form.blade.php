...
<div class="form-two-panel">
    ...
    <div class="form-panel-left">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" rows="5" placeholder="Brief description of this brand">{{ old('description', $brand->description) }}</textarea>
        </div>
    ...
    <div class="form-panel-right">
        ...
        <div class="form-group">
            ...
            <div class="paste-upload-zone brand-logo-upload" data-input="logo" tabindex="0">
