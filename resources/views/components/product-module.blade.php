...
<div class="product-module-card">
    <div class="product-module-header">
        <div class="product-image-container">
            @if($product->animal_image_url)
                <img src="{{ asset($product->animal_image_url) }}" alt="{{ $product->product_name }}" class="product-image">
            @else
    ...
    <div class="product-module-content">
        ...
        <div class="product-header-info">
            ...
            <p class="product-sku">SKU: <span>{{ $product->sku }}</span></p>
        </div>

        <!-- Category & Brand Info -->
        <div class="product-meta-info">
            @if($product->category)
                <span class="product-category">{{ $product->category->category_name ?? 'N/A' }}</span>
            @endif
        ...
        @if($product->animal_type)
            <div class="product-animal-type">
                <small>Type: <strong>{{ $product->animal_type }}</strong></small>
            </div>
        @endif
    </div>
