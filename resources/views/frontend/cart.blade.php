...
@section('hide-global-header-mobile', true)
...
<div class="cart-mobile-header">
    <a href="{{ route('shop.all') }}" aria-label="Back" class="mob-back-btn">
    ...
    <h2 class="mob-header-title">My Cart ({{ $cart->items->count() }})</h2>
    @if($cart->items->isNotEmpty())
    <form action="{{ route('cart.clear') }}" method="POST" class="mob-clear-cart" onsubmit="return confirm('Clear your entire cart?')">
        @csrf
                        ...
                        <div class="cart-item-bottom">
                            ...
                            <div class="cart-item-price-col">
                                @if($item->product->is_sale_active && $item->unit_price < $item->product->price)
                                    <div class="item-original-price">₱{{ number_format($item->product->price, 2) }}</div>
                                @endif
                                <div class="item-sale-price">₱{{ number_format($item->subtotal, 2) }}</div>
                            </div>
        ...
        <div class="cart-summary-col">
            <div class="order-summary-card">
                ...
                <div class="mob-continue-shopping-wrap hide-on-desktop">
                    <a href="{{ route('shop.all') }}" class="mob-continue-link">← Continue Shopping</a>
                </div>
