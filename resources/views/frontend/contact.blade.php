...
<div class="contact-container">
    @php
        ...
        $storeAddress = $settings->extra['store_address'] ?? 'Libertad, Butuan City, Agusan del Norte, Philippines';
        $storePhone = $settings->store_phone ?? '+63 912 345 6789';
        $storeEmail = $settings->store_email ?? 'support@petmarkt-ph.com';
    @endphp
    ...
    <div class="contact-layout">
        ...
        <div class="contact-map-card">
            <h2>Find Us</h2>
            <p class="subtitle">Visit our physical store.</p>
