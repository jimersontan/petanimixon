...
<body class="user-dashboard">
    <header class="ud-header">
        <div class="ud-header-inner">
            <a href="{{ route('shop') }}" class="ud-logo">
                <span style="font-size: 24px; margin-right: 8px;">🐾</span>
                <span class="ud-logo-text">Pet <span style="color: var(--ud-orange); font-weight: 700;">Animixon</span></span>
            </a>
            ...
            <nav class="ud-nav">
                ...
                <a href="#" class="ud-nav-link">Blog</a>
                <a href="#" class="ud-nav-link">Contact</a>
                <a href="#" class="ud-nav-link">Brands</a>
            ...
            @auth
                <div class="ud-header-actions">
                    <button type="button" class="ud-icon-btn" aria-label="Favorites">
                        <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                        </svg>
                    </button>

                    <button type="button" class="ud-icon-btn" aria-label="Cart">
                    ...
                    <div class="ud-user-dropdown">
                        <button id="udUserBtn" type="button" class="ud-user-btn" style="border: none; background: transparent; display: flex; align-items: center; gap: 8px; cursor: pointer;">
                            ...
                            <span class="ud-user-name" style="font-size: 14px; color: #333;">{{ Auth::user()->first_name ?? Auth::user()->email }}</span>
                        </button>
