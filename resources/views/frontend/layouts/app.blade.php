...
<head>
    ...
    <meta name="search-suggest-url" content="{{ route('search.suggestions') }}">
    @stack('styles')
</head>
<body class="user-dashboard theme-{{ Auth::check() ? (Auth::user()->color_theme ?? 'citrus_tail') : 'citrus_tail' }}">
    <header class="ud-header {{ View::hasSection('hide-global-header-mobile') ? 'hide-on-mobile' : '' }}">
        <div class="ud-header-inner">
            ...
            <div class="ud-header-center" style="display: flex; justify-content: center; flex: 1; margin: 0 24px;">
                <div class="ud-search-bar hide-on-mobile" style="width: 100%; max-width: 420px; position: relative;" id="searchBarWrap">
                    <form action="{{ route('shop.all') }}" method="GET" style="position: relative;" id="searchForm">
                        ...
                        <input type="text" name="q" class="ud-search-input" id="globalSearchInput" value="{{ request('q') }}" placeholder="Search products, brands..." autocomplete="off" style="width: 100%; padding: 10px 14px 10px 38px; border-radius: 24px; border: 1.5px solid #e8e8e8; background: #f7f7f7; font-size: 13px; transition: all 0.3s;" />
                    </form>
                    {{-- AJAX Search Suggestions Dropdown (Modal-style) --}}
            ...
            <div class="ud-header-right">
                ...
                @auth
                    <div class="ud-header-actions" style="margin: 0; gap: 8px;">
                        ...
                        <a href="{{ route('wishlist.index') }}" class="ud-icon-btn" aria-label="Wishlist" style="text-decoration:none;">
    ...
    <footer class="site-footer-premium">
        <div class="sfp-container">
            ...
            <div class="sfp-grid">
                <div class="sfp-col">
                    <a href="{{ route('shop') }}" class="sfp-brand-logo">
                        <img src="{{ asset('images/logo.png') }}" alt="Pet Markt-PH">
                ...
                <div class="sfp-col">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('returns.index') }}">Returns & Refunds</a></li>
                    </ul>
                </div>
                ...
                <div class="sfp-col">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('trial') }}">Free Trial</a></li>
            ...
            <div class="sfp-bottom">
                ...
                <div class="sfp-payments">
                    {{-- Placeholder secure payment icons --}}
    ...
    {{-- Mobile Bottom Nav + Search Modal + Auth Sheet --}}
            ...
            timer = setTimeout(function() {
                fetch('{{ route("search.suggestions") }}?q=' + encodeURIComponent(q))
                    ...
                    .then(function(data) {
                        ...
                        list.innerHTML = html;
                        viewAll.href = '{{ route("shop.all") }}?q=' + encodeURIComponent(q);
