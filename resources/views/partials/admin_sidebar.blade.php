...
<aside class="sidebar">
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('products.readonly') }}" class="nav-item {{ $current==='products.readonly' ? 'active':'' }}" data-page="products">
        ...
        <a href="{{ route('riders.admin') }}" class="nav-item {{ $current==='riders.admin' ? 'active':'' }}" data-page="riders">
