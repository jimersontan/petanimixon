    ...
    <div class="form-panel-left">
        ...
        <div class="form-group">
            ...
            <select name="animal_category_id" id="animal_category_id" class="form-control" required>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($cat->id); ?>" <?php echo e((old('animal_category_id', $product->animal_category_id) == $cat->id) ? 'selected' : ''); ?>>
                        <?php echo e($cat->category_name); ?>

                    </option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php if($errors->has('animal_category_id')): ?>
        ...
        <div class="form-row" style="display: none !important; gap: 15px;">
            ...
            <div class="form-group" style="flex: 1; min-width: 0;">
                ...
                <input type="number" step="0.01" name="price" id="price" class="form-control" style="width: 100%;" value="<?php echo e(old('price', $product->price ?? 0)); ?>">
            </div>
            <!-- End: Price -->
            <!-- Field: Stock (hidden default to 0) -->
            <div class="form-group" style="flex: 1; min-width: 0;">
                <label for="stock">Stock</label>
                <input type="number" min="0" name="stock" id="stock" class="form-control" style="width: 100%;" value="<?php echo e(old('stock', $product->stock ?? 0)); ?>">
            </div>
            <!-- End: Stock -->
        </div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/products/_form.blade.php ENDPATH**/ ?>