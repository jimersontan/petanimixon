    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar" id="adminSidebar">
            <nav class="sidebar-nav">
                ...
                <!-- Products Link -->
                <a href="<?php echo e(route('products.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>" data-page="products">
...
<!-- ===== END ADMIN LAYOUT ===== -->
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/layouts/admin.blade.php ENDPATH**/ ?>