    ...
    <main class="settings-main">
                ...
                <div class="store-info-grid">
                    ...
                    <div class="grid-column">
                        <div class="form-group">
                            ...
                            <input type="text" id="store_name" name="store_name" class="settings-input" value="<?php echo e(old('store_name', $s->store_name ?? '')); ?>" placeholder="e.g. Pet Animixon">
                        </div>
                        
                        <div class="form-group">
                            <label for="store_email">Store Email</label>
                            <input type="email" id="store_email" name="store_email" class="settings-input" value="<?php echo e(old('store_email', $s->store_email ?? '')); ?>" placeholder="support@petanimixon.com">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="store_url" name="store_url" class="settings-input" value="<?php echo e(old('store_url', $s->store_url ?? '')); ?>" placeholder="www.petanimixon.com">
                        </div>
                    ...
                    <div class="grid-column">
                        <div class="form-group" style="flex: 1; display:flex; flex-direction:column;">
                            ...
                            <div class="image-preview-wrapper" id="logo-preview-wrapper" style="<?php echo e(!empty($s->store_logo_path) ? 'display:flex;' : 'margin-top:0;'); ?>">
                                <img id="logo-preview-img" src="<?php echo e(!empty($s->store_logo_path) ? asset('storage/'.$s->store_logo_path) : ''); ?>" alt="Logo Preview">
        ...
        <section class="settings-panel" id="panel-payment-gateways">
            ...
            <form method="post" action="<?php echo e(route('settings.admin.update')); ?>" id="form-payment-gateways">
                ...
                <div class="form-group">
                    <label><input type="checkbox" name="gateway_bank" value="1" <?php echo e(($extra['gateway_bank'] ?? '0') == '1' ? 'checked' : ''); ?>> Bank Transfer</label>
                </div>
                <div class="form-group">
                    <label><input type="checkbox" name="gateway_online" value="1" <?php echo e(($extra['gateway_online'] ?? '0') == '1' ? 'checked' : ''); ?>> Online Payment (Card/GCash)</label>
                </div>
                <div class="form-group">
        ...
        <section class="settings-panel" id="panel-email-templates">
            ...
            <form method="post" action="<?php echo e(route('settings.admin.update')); ?>" id="form-email-templates">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email_from_name" class="settings-input" value="<?php echo e($extra['email_from_name'] ?? ($s->store_name ?? 'Pet Animixon')); ?>">
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/admin_settings.blade.php ENDPATH**/ ?>