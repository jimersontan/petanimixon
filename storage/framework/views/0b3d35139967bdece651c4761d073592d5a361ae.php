...
<?php $__env->startSection('title', 'PetMarkt-PH - Everything Your Pet Needs'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="ud-hero">
        ...
        <div class="pawnest-hero-wrapper">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem; width: 100%;">
                    <div style="min-width: 0;">
                        <div style="display: flex; align-items: center; gap: 0.4rem;">
                            <img src="<?php echo e(asset('images/sport-fire-sticker.gif')); ?>" alt="Sport Fire Sticker" class="pn-popular-header-img" style="width: 30px; height: 30px; object-fit: contain; flex-shrink: 0;">
                    ...
                    <a href="<?php echo e(route('shop.all')); ?>" class="pn-view-all" style="flex-shrink: 0;">View all &rarr;</a>
                </div>
                ...
                <div class="pn-slider" id="pn-banner-slider">
                    ...
                    <?php $__currentLoopData = $slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="pn-slide-item">
                            <a href="<?php echo e(route('product.show', $hp->id)); ?>" style="text-decoration: none; color: inherit; flex-grow: 1; display: flex; flex-direction: column;" onclick="window.openProductModal(<?php echo e($hp->id); ?>, event)">
                                ...
                                <div class="pn-pill pn-pill-green">
                                    <?php echo e($index % 2 == 0 ? 'Best Seller' : 'Top Rated'); ?>

                                </div>
                                <h4 class="pn-prod-title"><?php echo e($hp->product_name); ?></h4>
                                <?php
                                ...
                                ?>
                                <div class="pn-prod-reviews"><?php echo e($hpReviewAvg); ?> &starf; &middot; <?php echo e($hpReviewFmt); ?> <?php echo e(Str::plural('review', $hpReviewCount)); ?></div>
                                <?php
                                ...
                                <div class="pn-prod-price-area">
                                    <span class="pn-price-current">₱<?php echo e(number_format((float)$currentPrice, 2)); ?></span>
                                    <?php if($hasDiscount): ?>
                                        <span class="pn-price-old">₱<?php echo e(number_format((float)$hp->price, 0)); ?></span>
                                    <?php endif; ?>
                                </div>
                            </a>
                            <?php if(auth()->guard()->check()): ?>
                                <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="product_id" value="<?php echo e($hp->id); ?>">
                                    <input type="hidden" name="quantity" value="1">
                                    <button type="submit" class="pn-btn-faint">Add to Cart</button>
                                </form>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="pn-btn-faint" style="display: block; text-decoration: none; box-sizing: border-box; text-align: center;">Add to Cart</a>
                            <?php endif; ?>
                        </div>
            ...
            <div class="pawnest-hero-right">
                <?php if(isset($promoCoupons) && $promoCoupons->count() > 0): ?>
                    <?php $__currentLoopData = $promoCoupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        ?>
                        <a href="<?php echo e(route('product.show', $promoProduct->id)); ?>" class="pn-right-card" style="text-decoration: none; color: inherit;" onclick="window.openProductModal(<?php echo e($promoProduct->id); ?>, event)">
                            <div class="pn-right-img-box <?php echo e($imgBgClass); ?>">
                                <img src="<?php echo e($promoProduct->image_url); ?>" alt="<?php echo e($promoProduct->product_name); ?>" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22150%22 height=%22150%22%3E%3Crect fill=%22%23f5f5f5%22 width=%22150%22 height=%22150%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 font-family=%22Arial%22 font-size=%2215%22 fill=%22%23bbb%22 text-anchor=%22middle%22 dy=%22.3em%22%3ENo Image%3C/text%3E%3C/svg%3E';">
                            </div>
                            <div style="flex: 1; display: flex; flex-direction: column;">
                                <div class="pn-pill pn-pill-red"><?php echo e($discountLabel); ?></div>
                                <h4 class="pn-prod-title" style="font-size: 1.05rem;"><?php echo e($promoProduct->product_name); ?></h4>
                                <p style="font-size: 13px; color: #888; margin: 0 0 auto; line-height: 1.4;"><?php echo e($promo->description ?: Str::limit($promoProduct->short_description, 60)); ?></p>
                                
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 12px;">
                                    <div class="pn-prod-price-area" style="margin-bottom: 0;">
                                        <span class="pn-price-current">₱<?php echo e(number_format((float)$promoProduct->price, 2)); ?></span>
                                        <span class="pn-price-old">₱<?php echo e(number_format($originalPrice, 0)); ?></span>
                                    </div>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php elseif(isset($featuredSaleProducts) && $featuredSaleProducts->count() > 0): ?>
                    
                    <?php $__currentLoopData = $featuredSaleProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $saleProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $isFirst = ($index === 0);
                            $imgBgClass = $isFirst ? 'bg-cream' : 'bg-blue';
                        ?>
                        <a href="<?php echo e(route('product.show', $saleProduct->id)); ?>" class="pn-right-card" style="text-decoration: none; color: inherit;" onclick="window.openProductModal(<?php echo e($saleProduct->id); ?>, event)">
                            <div class="pn-right-img-box <?php echo e($imgBgClass); ?>">
                                <img src="<?php echo e($saleProduct->image_url); ?>" alt="<?php echo e($saleProduct->product_name); ?>" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22150%22 height=%22150%22%3E%3Crect fill=%22%23f5f5f5%22 width=%22150%22 height=%22150%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 font-family=%22Arial%22 font-size=%2215%22 fill=%22%23bbb%22 text-anchor=%22middle%22 dy=%22.3em%22%3ENo Image%3C/text%3E%3C/svg%3E';">
                            </div>
                            <div style="flex: 1; display: flex; flex-direction: column;">
                                <div class="pn-pill pn-pill-red">🏷️ SALE</div>
                                <h4 class="pn-prod-title" style="font-size: 1.05rem;"><?php echo e($saleProduct->product_name); ?></h4>
                                <p style="font-size: 13px; color: #888; margin: 0 0 auto; line-height: 1.4;"><?php echo e(Str::limit($saleProduct->short_description, 60)); ?></p>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 12px;">
                                    <div class="pn-prod-price-area" style="margin-bottom: 0;">
                                        ...
                                        ?>
                                        <span class="pn-price-current">₱<?php echo e(number_format((float)$salePrice, 2)); ?></span>
                                        <span class="pn-price-old">₱<?php echo e(number_format((float)$saleProduct->price, 0)); ?></span>
                                    </div>
                ...
                <?php else: ?>
                    ...
                    ?>
                    <?php $__currentLoopData = $featuredArray; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $isFirst = ($index === 0);
                        ...
                        <div class="pn-right-card">
                            <div class="pn-right-img-box <?php echo e($imgBgClass); ?>">
                                <img src="<?php echo e($fp->image_url); ?>" alt="<?php echo e($fp->product_name); ?>" onerror="this.onerror=null; this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22150%22 height=%22150%22%3E%3Crect fill=%22%23f5f5f5%22 width=%22150%22 height=%22150%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 font-family=%22Arial%22 font-size=%2215%22 fill=%22%23bbb%22 text-anchor=%22middle%22 dy=%22.3em%22%3ENo Image%3C/text%3E%3C/svg%3E';">
                            </div>
                            <div style="flex: 1; display: flex; flex-direction: column;">
                                <div class="pn-pill <?php echo e($pillClass); ?>"><?php echo e($discount); ?></div>
                                <h4 class="pn-prod-title" style="font-size: 1.15rem;"><?php echo e($fp->product_name); ?></h4>
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: auto;">
                                    ...
                                    <div class="pn-prod-price-area" style="margin-bottom: 0;">
                                        <span class="pn-price-current">₱<?php echo e(number_format((float)$currentPrice, 2)); ?></span>
                                        <?php if($hasDiscount): ?>
                                            <span class="pn-price-old">₱<?php echo e(number_format((float)$fp->price, 0)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <?php if(auth()->guard()->check()): ?>
                                        <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>" class="pn-plus-btn" style="display: flex; align-items: center; justify-content: center; text-decoration: none;">&plus;</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
        ...
        <div class="sales-section">
            <div class="sales-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                ...
                <a href="<?php echo e(route('shop.all', ['discount' => 'on_sale'])); ?>" class="sales-view-all" style="color: var(--ud-orange, #E85D04); font-weight: 700; font-size: 15px; text-decoration: none; display: inline-flex; align-items: center; gap: 6px;">
            ...
            <div class="sales-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); gap: 20px;">
                ...
                <a href="<?php echo e(route('product.show', $saleProduct->id)); ?>" style="text-decoration: none; color: inherit;" onclick="window.openProductModal(<?php echo e($saleProduct->id); ?>, event)">
                    <div class="sales-card" style="border: 1px solid #eee; border-radius: 12px; overflow: hidden; transition: all 0.25s; hover:box-shadow: 0 8px 20px rgba(0,0,0,0.06); hover:border-color: var(--ud-orange, #E85D04);">
                        ...
                        <div class="sales-card-content" style="padding: 12px;">
                            <h3 class="sales-card-title" style="font-size: 13px; font-weight: 600; color: #1a202c; margin: 0 0 8px; line-height: 1.3; min-height: 26px;"><?php echo e(Str::limit($saleProduct->product_name, 50)); ?></h3>
                            <div class="sales-card-brand" style="font-size: 12px; color: #888; margin-bottom: 8px;"><?php echo e($saleProduct->brand_name ?? 'N/A'); ?></div>
                            <div style="display: flex; gap: 8px; align-items: center;">
                                ...
                                ?>
                                <span class="sales-card-price" style="font-size: 15px; font-weight: 700; color: var(--ud-orange, #E85D04);">₱<?php echo e(number_format((float)$salePrice, 0)); ?></span>
                                <span class="sales-card-original" style="font-size: 13px; color: #bbb; text-decoration: line-through;">₱<?php echo e(number_format((float)$saleProduct->price, 0)); ?></span>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="ud-pet-categories" style="margin-bottom: 3rem; margin-top: 1.5rem;">
            ...
            <div class="pet-categories-grid"
                ...
                <a href="<?php echo e(route('shop.all', ['pet_type' => [$at->animal_type]])); ?>" class="pet-cat-item"
                    ...
                    <div class="pet-cat-circle"
                        ...
                        <?php if($at->image_url): ?>
                            <img src="<?php echo e(asset('storage/' . $at->image_url)); ?>" alt="<?php echo e($at->animal_type); ?>" style="width: 70%; height: 70%; object-fit: contain;">
                        <?php else: ?>
                            <span style="font-size: 42px;">🐾</span>
                        <?php endif; ?>
                    </div>
                    <span style="font-size: 15px; font-weight: 600; color: #333;"><?php echo e($at->animal_type); ?></span>
                </a>
    ...
    <section class="ud-section ud-categories">
        ...
        <div class="ud-category-grid" id="udCategoryGrid">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                ?>
                <a href="<?php echo e(route('categories.show', $category->id)); ?>" class="ud-category-card <?php echo e($bgClass); ?>">
                    <div class="ud-category-card-inner">
                        <?php if(!empty($category->image_url)): ?>
                            <img src="<?php echo e(asset('storage/' . $category->image_url)); ?>" alt="<?php echo e($category->category_name); ?>" class="ud-cat-image">
                        <?php endif; ?>
                        <div class="ud-category-card-title"><?php echo e($category->category_name); ?></div>
                        <div class="ud-category-card-meta"><?php echo e($category->products()->count()); ?> items available</div>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <section class="ud-section" style="max-width: 1400px; margin: 0 auto; padding: 0 2rem; margin-bottom: 4rem;">
        <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 1.5rem;">
            ...
            <a href="<?php echo e(route('shop.all')); ?>" style="color: var(--ud-orange, #FF8C42); font-weight: 600; text-decoration: none; padding-bottom: 0.5rem; display: flex; align-items: center; gap: 0.5rem;">View All <span style="font-size: 1.2rem;">&rarr;</span></a>
        </div>
        ...
        <div class="products-grid">
            <?php $__empty_1 = true; $__currentLoopData = $latestProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="product-card">
                    <div style="cursor:pointer;" onclick="window.openProductModal(<?php echo e($product->id); ?>, event)">
                        <div class="product-img-wrap" onclick="event.stopPropagation(); window.openProductModal(<?php echo e($product->id); ?>, event)">
                            <img
                        ...
                        <div class="product-body">
                            ...
                            <h3 class="product-name" style="cursor:pointer; transition:color 0.2s;" onmouseover="this.style.color='var(--ud-orange)'" onmouseout="this.style.color='inherit'" onclick="event.stopPropagation(); window.openProductModal(<?php echo e($product->id); ?>, event)"><?php echo e($product->product_name); ?></h3>
                            ...
                            ?>
                            <div class="product-rating" title="<?php echo e(number_format($pReviewAvg, 1)); ?> out of 5 stars">
                                <span class="stars"><?php echo str_repeat('★', $roundedAvg); ?><?php echo str_repeat('☆', 5 - $roundedAvg); ?></span>
                                <span class="count">(<?php echo e($pFmt); ?>)</span>
                            </div>

                            <div class="product-price-row">
                                <span class="product-price">₱<?php echo e(number_format((float)$product->price, 0)); ?></span>
                                <?php if($product->is_reduced): ?>
                                    <span style="font-size: 13px; color: #bbb; text-decoration: line-through;">₱<?php echo e(number_format((float)$product->price * 1.2, 0)); ?></span>
                                <?php endif; ?>
                            </div>
                    ...
                    <div style="padding: 0 16px 16px 16px; margin-top: auto;">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn-add-to-cart" style="display: block; text-align: center; text-decoration: none; width: 100%; box-sizing: border-box;">Add to Cart</a>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
