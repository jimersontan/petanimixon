<?php $__env->startSection('title', 'Checkout - PetMarkt-PH'); ?>
    ...
    <form id="checkoutForm" action="<?php echo e(route('checkout.process')); ?>" method="POST">
        ...
        <div class="co-panel active" id="step1">
            <div class="co-card">
                ...
                <div class="co-item">
                    <img class="co-item-img" src="<?php echo e($item->product->image_url); ?>" alt="<?php echo e($item->product->product_name); ?>" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%2270%22 height=%2270%22%3E%3Crect fill=%22%23f5f5f5%22 width=%2270%22 height=%2270%22/%3E%3C/svg%3E'">
                    <div class="co-item-info">
                        <div class="co-item-name"><?php echo e($item->product->product_name); ?></div>
                        <div class="co-item-meta">Qty: <?php echo e($item->quantity); ?> · ₱<?php echo e(number_format($item->unit_price, 2)); ?> each</div>
                    </div>
                    <div class="co-item-price">
                        <div class="co-item-total">₱<?php echo e(number_format($item->subtotal, 2)); ?></div>
                    </div>
                </div>
        ...
        <div class="co-panel" id="step2">
            <div class="co-card">
                ...
                <div class="co-addr-card <?php echo e($loop->first ? 'selected' : ''); ?>" onclick="selectAddr(this, <?php echo e($addr->id); ?>)">
                    <input type="radio" name="_addr_radio" value="<?php echo e($addr->id); ?>" <?php echo e($loop->first ? 'checked' : ''); ?>>
                    <div class="co-addr-name"><?php echo e($addr->recipient_name); ?></div>
                    <div class="co-addr-detail"><?php echo e($addr->phone_number); ?><br><?php echo e($addr->street_address); ?>, <?php echo e($addr->barangay ? $addr->barangay . ', ' : ''); ?><?php echo e($addr->city_municipality); ?>, <?php echo e($addr->province); ?> <?php echo e($addr->zip_code); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
                <div class="co-new-addr-toggle" onclick="toggleNewAddr()" <?php if($addresses->isEmpty()): ?> style="display:none;" <?php endif; ?>>
                    <span style="font-size:20px;">＋</span> Add New Address
                </div>
                <div id="newAddrForm" style="display:<?php echo e($addresses->isEmpty() ? 'block' : 'none'); ?>; margin-top:16px;">
            ...
            <div class="co-card">
                ...
                <div class="co-ship-option selected" onclick="selectShip(this,'standard')">
                    ...
                    <div class="co-ship-price" id="priceStandard">
                        <?php if($subtotal >= 1500): ?> <span class="co-ship-free">FREE</span> <?php elseif($subtotal >= 500): ?> ₱59 <?php else: ?> ₱99 <?php endif; ?>
                    </div>
                </div>
                <div class="co-ship-option" onclick="selectShip(this,'express')">
                    ...
                    <div class="co-ship-price" id="priceExpress">
                        <?php if($subtotal >= 1500): ?> ₱99 <?php else: ?> ₱199 <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="co-panel" id="step4">
            ...
            <div class="co-card">
                ...
                <div class="co-voucher-row">
                    <input type="text" class="co-voucher-input" id="voucherInput" placeholder="Enter voucher code (e.g. PETLOVE10)" value="<?php echo e(session('active_voucher')); ?>">
            ...
            <div class="co-card">
                ...
                <div class="co-review-section">
                    ...
                    <div style="display:flex; justify-content:space-between; font-size:13px; padding:4px 0; color:#555;">
                        <span><?php echo e($item->product->product_name); ?> × <?php echo e($item->quantity); ?></span>
                ...
                <div class="co-summary-row"><span>Subtotal</span><span>₱<?php echo e(number_format($subtotal, 2)); ?></span></div>
                ...
                <div class="co-summary-row total"><span>Total</span><span id="reviewTotal">₱<?php echo e(number_format($subtotal, 2)); ?></span></div>
            </div>
            <div class="co-nav">
...
document.getElementById('hAddr').value = <?php echo e($addresses->first()->id); ?>;
<?php endif; ?>
...
function applyVoucher() {
    ...
    fetch('<?php echo e(route("checkout.voucher")); ?>', {
        method: 'POST',
...
<script src="<?php echo e(asset('js/ph-address.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>



<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/frontend/checkout.blade.php ENDPATH**/ ?>