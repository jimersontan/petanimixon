...
<?php $__env->startSection('title', 'Shipping Info - Pet Animixon'); ?>
    ...
    <div class="shipping-section">
        ...
        <div class="shipping-cards">
            ...
            <div class="shipping-card">
                <span class="card-icon">🏪</span>
                <h3>Store Pickup</h3>
                <p>Order online and pick up at our Makati store.</p>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/frontend/shipping.blade.php ENDPATH**/ ?>