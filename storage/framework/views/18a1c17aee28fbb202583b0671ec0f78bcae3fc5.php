...
<div class="content-header">
    ...
    <div class="date-filter">
        ...
        <form method="get" action="<?php echo e(route('products.readonly')); ?>" class="date-filter-form" id="productsDateForm">
            <!-- Brand Filter -->
                ...
                <tr data-status="<?php echo e($product->product_status ?? 'active'); ?>">
                    ...
                    <td>
                        <div class="product-cell">
                            <img src="<?php echo e($product->image_url); ?>" alt="Product Thumb" class="product-thumb-sm" style="object-fit: cover;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/products_readonly.blade.php ENDPATH**/ ?>