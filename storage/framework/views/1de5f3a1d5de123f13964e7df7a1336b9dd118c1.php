...
<div class="contact-container">
    ...
    <div class="contact-info-grid">
        ...
        <div class="contact-info-card">
            ...
            <h4>Address</h4>
            <p>123 Pet Street, Makati City, Philippines</p>
        </div>
        <div class="contact-info-card">
            <div class="card-icon">
    ...
    <div class="contact-layout">
        ...
        <div class="contact-map-card">
            <h2>Find Us</h2>
            <p class="subtitle">Visit our physical store in Makati City.</p>
            <div class="map-placeholder">
                📍 Map — 123 Pet Street, Makati City
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/frontend/contact.blade.php ENDPATH**/ ?>