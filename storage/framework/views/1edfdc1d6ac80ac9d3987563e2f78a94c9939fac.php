        ...
        <div class="table-wrap">
            <table class="orders-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong style="color: var(--ud-orange-dark); font-family: monospace; font-size: 14px;"><?php echo e($coupon->coupon_code); ?></strong></td>
        ...
        <div class="table-wrap">
            <table class="orders-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-actions" style="display: flex; gap: 8px; align-items: center;">
                            <button type="button" class="action-btn" title="Edit Sale" style="padding: 6px 10px; font-size: 16px; background: none; border: none; cursor: pointer;" onclick="openSalesModal('edit', {
                                ...
                                product_name: '<?php echo e(addslashes($product->product_name)); ?>',
                                discount_type: '<?php echo e($product->discount_type); ?>',
                                discount_amount: '<?php echo e($product->discount_amount); ?>',
                                valid_from: '<?php echo e($product->sale_valid_from ? $product->sale_valid_from->format('Y-m-d\TH:i') : ''); ?>',
                                valid_until: '<?php echo e($product->sale_valid_until ? $product->sale_valid_until->format('Y-m-d\TH:i') : ''); ?>',
                                is_featured: <?php echo e($product->is_featured ? 'true' : 'false'); ?>
                    ...
                    <tr>
                        <td colspan="7" class="text-center" style="padding: 40px 20px; color: #999;">
                            🏷️ No products on sale yet. <a href="<?php echo e(route('products.readonly')); ?>" style="color: var(--ud-orange-dark); font-weight: 600;">Manage products →</a>
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
...
function openSalesModal(mode = 'add', data = null) {
    ...
    form.reset();
    methodContainer.innerHTML = '';
    form.action = "<?php echo e(route('products.storeSale')); ?>";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/coupons_admin.blade.php ENDPATH**/ ?>