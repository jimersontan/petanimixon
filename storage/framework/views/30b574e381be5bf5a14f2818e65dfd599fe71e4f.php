...
<div class="analytics-dashboard">
    ...
    <div class="analytics-header">
        ...
        <div class="analytics-controls">
            <form method="get" action="<?php echo e(route('analytics.admin')); ?>" id="dateFilterForm" style="margin:0;">
    ...
    <div class="analytics-grid-4">
        ...
        <div class="analytics-card">
            ...
            <div class="stat-value"><?php echo e(number_format($stats['units_sold'])); ?></div>
        ...
        <div class="analytics-card">
            ...
            <div class="stat-value">₱<?php echo e(number_format($stats['avg_order_value'], 2)); ?></div>
                        ...
                        <tr>
                            <td>
                                <div class="product-cell">
                                    <?php if(optional($item->product)->animal_image_url): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->product->animal_image_url)); ?>" class="product-img">
                                    <?php else: ?>
                                        <div class="product-img" style="display:flex;align-items:center;justify-content:center;">📦</div>
                                    <?php endif; ?>
                                    <span style="font-weight: 500;"><?php echo e(optional($item->product)->product_name ?? 'Unknown Product'); ?></span>
                                </div>
                            </td>
                            <td style="text-align: right; color: #4b5563;"><?php echo e(number_format($item->total_sold)); ?></td>
                            <td style="text-align: right; font-weight: 600; color: #059669;">₱<?php echo e(number_format($item->total_revenue, 2)); ?></td>
                        </tr>
            ...
            <div class="analytics-table-wrap">
                <table class="analytics-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="font-family: monospace; color: #6b7280;">#<?php echo e(str_pad($order->id, 5, '0', STR_PAD_LEFT)); ?></td>
                            <td style="font-weight: 500;"><?php echo e($order->user ? $order->user->full_name : 'Guest'); ?></td>
                            <td style="color: #4b5563;"><?php echo e($order->created_at->format('M j, Y')); ?></td>
                            <td style="text-align: right; font-weight: 600;">₱<?php echo e(number_format($order->total_amount, 2)); ?></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Revenue Chart
    const revenueLabels = <?php echo json_encode($chartLabels ?? []); ?>;
    const revenueData = <?php echo json_encode($chartData ?? []); ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Pet Markt-PH\resources\views/analytics_admin.blade.php ENDPATH**/ ?>