                ...
                <form id="riderLoginForm" method="POST" action="<?php echo e(route('rider.login.submit')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="email" id="email" name="email" placeholder="rider@petmarkt.com" class="form-control" value="<?php echo e(old('email')); ?>" required autofocus>
                        </div>
                    </div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/rider_login.blade.php ENDPATH**/ ?>