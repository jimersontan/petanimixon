    ...
    <div class="paste-upload-zone" tabindex="0">
        ...
        <div class="upload-preview">
            <?php if(!empty($brand->logo_path)): ?>
                <img src="<?php echo e(asset('storage/'.$brand->logo_path)); ?>" alt="<?php echo e($brand->name); ?> logo">
            <?php endif; ?>
        </div>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\Petverse\petverse\resources\views/brands/_form.blade.php ENDPATH**/ ?>