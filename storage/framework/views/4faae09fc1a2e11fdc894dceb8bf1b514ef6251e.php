...
<div class="metrics-grid">
    <div class="metric-card">
        ...
        <div class="metric-content"><div class="metric-value"><?php echo e($stats['total']); ?></div><div class="metric-label">Total Sellers</div></div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-content"><div class="metric-value"><?php echo e($stats['verified']); ?></div><div class="metric-label">Verified</div></div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-content"><div class="metric-value"><?php echo e($stats['pending']); ?></div><div class="metric-label">Pending Review</div></div>
    </div>
    <div class="metric-card">
        ...
        <div class="metric-content"><div class="metric-value"><?php echo e($stats['inactive']); ?></div><div class="metric-label">Inactive</div></div>
    </div>
</div>
...
<div class="card orders-table-card">
    ...
    <div class="order-status-tabs" role="tablist">
        <a href="<?php echo e(route('sellers.admin')); ?>" class="order-tab <?php echo e(!request('status') ? 'active' : ''); ?>">All</a>
        <a href="<?php echo e(route('sellers.admin', ['status' => 'verified'])); ?>" class="order-tab <?php echo e(request('status') === 'verified' ? 'active' : ''); ?>">Verified</a>
        <a href="<?php echo e(route('sellers.admin', ['status' => 'pending'])); ?>" class="order-tab <?php echo e(request('status') === 'pending' ? 'active' : ''); ?>">Pending</a>
        <a href="<?php echo e(route('sellers.admin', ['status' => 'inactive'])); ?>" class="order-tab <?php echo e(request('status') === 'inactive' ? 'active' : ''); ?>">Inactive</a>
    </div>
    <div class="table-wrap">
        <table class="orders-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong><?php echo e($seller->store_name); ?></strong></td>
                    <td><?php echo e($seller->business_name); ?></td>
                    <td><?php echo e($seller->business_email); ?></td>
                    <td><?php echo e($seller->products_count ?? 0); ?></td>
                    <td>
                        ...
                        <?php else: ?>
                            <span class="status-badge" style="background:#fee2e2; color:#dc2626;"><?php echo e(ucfirst($seller->verification_status)); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="col-actions">
                        <button type="button" class="action-btn" title="Edit" onclick="openSellerModal('edit', {
                            id: <?php echo e($seller->id); ?>,
                            business_name: '<?php echo e(addslashes($seller->business_name)); ?>',
                            business_email: '<?php echo e($seller->business_email); ?>',
                            business_phone: '<?php echo e($seller->business_phone); ?>',
                            business_registration_number: '<?php echo e($seller->business_registration_number); ?>',
                            business_registration_number_type: '<?php echo e($seller->business_registration_number_type); ?>',
                            business_description: '<?php echo e(addslashes($seller->business_description ?? '')); ?>',
                            store_name: '<?php echo e(addslashes($seller->store_name)); ?>',
                            store_description: '<?php echo e(addslashes($seller->store_description ?? '')); ?>',
                            verification_status: '<?php echo e($seller->verification_status); ?>'
                        })">
                        ...
                        <form method="POST" action="<?php echo e(route('sellers.toggle', $seller->id)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
                            <button type="submit" class="action-btn" title="<?php echo e($seller->is_active ? 'Deactivate' : 'Activate'); ?>">
    ...
    <div class="table-wrap">
        <table class="orders-table">
            ...
            <tbody>
                ...
                <tr>
                    <td><code><?php echo e($payout->transaction_reference); ?></code></td>
                    <td><?php echo e($payout->seller->store_name ?? '—'); ?></td>
                    <td><strong>₱<?php echo e(number_format($payout->payout_amount, 2)); ?></strong></td>
                    <td><?php echo e(ucfirst(str_replace('_',' ',$payout->payout_method))); ?></td>
                    <td><span class="status-badge" style="background:#dcfce7; color:#16a34a;"><?php echo e(ucfirst($payout->payout_status)); ?></span></td>
                    <td><?php echo e($payout->created_at->format('M j, Y')); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="seller-modal" class="modal" style="max-width: 700px; width: 95%;">
    ...
    <div class="modal-body">
        <form id="sellerModalForm" method="POST" action="<?php echo e(route('sellers.store')); ?>">
            <?php echo csrf_field(); ?>
...
<div id="payout-modal" class="modal" style="max-width: 500px; width: 95%;">
    ...
    <div class="modal-body">
        <form method="POST" action="<?php echo e(route('sellers.payout')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group"><label>Seller *</label>
                <select name="seller_id" class="form-control" required>
                    <option value="">Select seller...</option>
                    <?php $__currentLoopData = \App\Models\Seller::where('is_active', true)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s->id); ?>"><?php echo e($s->store_name); ?></option>
...
function openSellerModal(mode, data = null) {
    ...
    if (mode === 'add') {
        ...
        form.action = "<?php echo e(route('sellers.store')); ?>";
        mc.innerHTML = '';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/sellers_admin.blade.php ENDPATH**/ ?>