                    ...
                    <table class="orders-table" id="ordersTable">
                        ...
                        <tbody>
                            ...
                            <tr data-status="<?php echo e($order->order_status); ?>">
                                ...
                                <!-- Order Status Badge -->
                                <td><span class="badge <?php echo e($statusBadge[$order->order_status] ?? 'badge-pending'); ?>"><?php echo e($order->status_label); ?></span></td>
                                <!-- Action Buttons: View and Edit -->
                                <td class="col-actions">
                                    <!-- View Button -->
                                    <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="action-btn" title="View" aria-label="View order"><svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg></a>
                                    <!-- Edit Button -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/orders.blade.php ENDPATH**/ ?>