        ...
        <div class="ud-product-grid">
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="ud-product-card">
                    ...
                    <h4 onclick="window.openProductModal(<?php echo e($product->id); ?>, event)" style="cursor:pointer; transition:color 0.2s;" onmouseover="this.style.color='#FF8C42'" onmouseout="this.style.color='inherit'"><?php echo e($product->product_name); ?></h4>
