...
<body>
    <header class="home-header">
        ...
        <nav class="home-nav">
            ...
            <span><?php echo e(Auth::user()->full_name ?? Auth::user()->email); ?></span>
    ...
    <main class="home-main">
        <?php if(session('message')): ?>
            <div class="msg"><?php echo e(session('message')); ?></div>
        <?php endif; ?>
        <h1>Welcome to Petverse!</h1>
        <p>Hi <?php echo e(Auth::user()->full_name ?? Auth::user()->email); ?>, browse pet products and shop for your furry friends.</p>
        <div class="home-actions">
            <a href="<?php echo e(route('orders')); ?>" class="btn btn-primary">View My Orders</a>
        </div>
    </main>
</body>
</html>
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views\home.blade.php ENDPATH**/ ?>