            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                <div>
                    <div style="font-weight: 700; color: #1a1a2e; margin-bottom: 4px;">
                        ...
                        <a href="<?php echo e(route('product.show', $question->product_id)); ?>" style="color: var(--ud-orange-dark); text-decoration: none; font-weight: 600;"><?php echo e($question->product->product_name ?? 'Product #'.$question->product_id); ?></a>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/qa_admin.blade.php ENDPATH**/ ?>