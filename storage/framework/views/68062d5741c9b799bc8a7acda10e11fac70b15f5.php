<header class="dashboard-header">
    ...
    <div class="header-right">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="profileMenuButton">
                ...
                <div class="dropdown-header">
                    <div class="user-info">
                        <div class="user-name"><?php echo e(auth()->user()->full_name ?? auth()->user()->name ?? auth()->user()->email); ?></div>
                        <?php if(auth()->user()->adminRole()): ?>
                        <div class="user-role">
                            <span class="role-badge" style="background: #ff6b35; color: white; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-weight: 600;">
                                <?php echo e(ucwords(str_replace('_', ' ', auth()->user()->adminRole()))); ?>
        ...
        <a href="<?php echo e(route('admin.profile')); ?>" class="icon-btn" aria-label="Settings" title="Go to profile settings">
...
</header><?php /**PATH C:\xampp\htdocs\Petverse\petverse\resources\views/partials/admin_header.blade.php ENDPATH**/ ?>