    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-item active" data-page="dashboard">
                ...
                <a href="<?php echo e(route('orders')); ?>" class="nav-item" data-page="orders">
                ...
                <a href="#" class="nav-item" data-page="brands">
            ...
            <a href="<?php echo e(url('/')); ?>" class="sidebar-back">
            ...
            <div class="metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value" id="totalRevenue">₱72,065</div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value" id="totalOrders">342</div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value" id="newCustomers">89</div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value" id="avgOrderValue">₱3,447</div>
                    ...
                    <ul class="top-products-list" id="topProductsList">
                        <li class="top-product-item">
                            ...
                            <div class="product-info">
                                <span class="product-name">Premium Dog Food</span>
                                <span class="product-category">Dog Food</span>
                            </div>
                            <span class="product-sold">234 sold</span>
                        </li>
                        <li class="top-product-item">
                            <div class="product-thumb"></div>
                            <div class="product-info">
                                <span class="product-name">Cat Interactive Toy</span>
                                <span class="product-category">Cat Toys</span>
                            </div>
                            <span class="product-sold">189 sold</span>
                        </li>
                        <li class="top-product-item">
                            <div class="product-thumb"></div>
                            <div class="product-info">
                                <span class="product-name">Grooming Brush</span>
                                <span class="product-category">Grooming</span>
                            </div>
                            <span class="product-sold">156 sold</span>
                        </li>
                        <li class="top-product-item">
                            <div class="product-thumb"></div>
                            <div class="product-info">
                                <span class="product-name">Travel Carrier</span>
                                <span class="product-category">Accessories</span>
                            </div>
                            <span class="product-sold">123 sold</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="dashboard-grid-two">
                <div class="card orders-card">
                    <div class="card-title-row">
                        ...
                        <a href="#" class="btn-primary">View All Orders</a>
                    </div>
                    <div class="table-wrap">
                        <table class="data-table">
                            ...
                            <tbody id="recentOrdersBody">
                                <tr>
                                    <td>#12456</td>
                                    <td><div class="customer-cell">Justin Bieber</div><div class="customer-email">justin@example.com</div></td>
                                    <td>P7,998</td>
                                    <td><span class="status-badge">—</span></td>
                                </tr>
                                <tr>
                                    <td>#12455</td>
                                    <td><div class="customer-cell">Michael Jackson</div><div class="customer-email">michael@example.com</div></td>
                                    <td>P5,998</td>
                                    <td><span class="status-badge">—</span></td>
                                </tr>
                                <tr>
                                    <td>#12454</td>
                                    <td><div class="customer-cell">Dua Lipa</div><div class="customer-email">dua@example.com</div></td>
                                    <td>P3,455</td>
                                    <td><span class="status-badge">—</span></td>
                                </tr>
                            </tbody>
                    ...
                    <ul class="low-stock-list" id="lowStockList">
                        <li class="low-stock-item">
                            ...
                            <div class="stock-info">
                                <span class="stock-name">Dog Treats</span>
                                <span class="stock-qty">Only 3 left</span>
                            </div>
                        ...
                        <li class="low-stock-item">
                            <div class="stock-thumb"></div>
                            <div class="stock-info">
                                <span class="stock-name">Cat Litter</span>
                                <span class="stock-qty">Only 5 left</span>
                            </div>
                            <button type="button" class="btn-restock">Restock</button>
                        </li>
                        <li class="low-stock-item">
                            <div class="stock-thumb"></div>
                            <div class="stock-info">
                                <span class="stock-name">Pet Vitamins</span>
                                <span class="stock-qty">Only 2 left</span>
                            </div>
                            <button type="button" class="btn-restock">Restock</button>
                        </li>
                    </ul>
            ...
            <div class="card activity-card">
                ...
                <ul class="activity-list" id="activityList">
                    <li class="activity-item">
                        <span class="activity-icon activity-icon-order"></span>
                        <div class="activity-content">
                            <span class="activity-text"><strong>John Doe</strong> placed a new order #123456</span>
                            <span class="activity-time">2 minutes ago</span>
                        </div>
                    </li>
                    <li class="activity-item">
                        <span class="activity-icon activity-icon-register"></span>
                        <div class="activity-content">
                            <span class="activity-text">New customer registration: <strong>Alice Smith</strong></span>
                            <span class="activity-time">5 minutes ago</span>
                        </div>
                    </li>
                    <li class="activity-item">
                        <span class="activity-icon activity-icon-review"></span>
                        <div class="activity-content">
                            <span class="activity-text"><strong>Tom Wilson</strong> left a 5-star review for Premium Dog Food</span>
                            <span class="activity-time">12 minutes ago</span>
                        </div>
                    </li>
                    <li class="activity-item">
                        <span class="activity-icon activity-icon-return"></span>
                        <div class="activity-content">
                            <span class="activity-text">Return request submitted for order #123445</span>
...
<?php /**PATH C:\xampp\htdocs\Petverse\petverse\resources\views/dashboard.blade.php ENDPATH**/ ?>