    ...
    <header class="dashboard-header">
        ...
        <div class="header-center">
            <div class="search-bar">
                ...
                <input type="text" class="search-input" placeholder="Search revenue reports...">
            </div>
        </div>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="<?php echo e(route('brands.admin')); ?>" class="nav-item" data-page="brands">
                ...
                <a href="<?php echo e(route('revenue.admin')); ?>" class="nav-item active" data-page="revenue">
        ...
        <main class="main-content">
            <div class="content-header">
                ...
                <div class="date-filter">
                    <form method="get" action="<?php echo e(route('revenue.admin')); ?>" class="date-filter-form" id="revenueDateForm">
            ...
            <div class="metrics-grid">
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">₱<?php echo e(number_format($stats['total_revenue'] ?? 0)); ?></div>
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        <div class="metric-value"><?php echo e(number_format($stats['refunds'] ?? 0)); ?></div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/revenue_admin.blade.php ENDPATH**/ ?>