    ...
    <header class="ud-header">
        <div class="ud-header-inner">
            ...
            <div class="ud-header-center" style="display: flex; justify-content: center; flex: 1; margin: 0 24px;">
                <form action="<?php echo e(route('shop.all')); ?>" method="GET" class="ud-search-bar hide-on-mobile" style="width: 100%; max-width: 400px; position: relative;">
                    ...
                    <input type="text" name="q" class="ud-search-input" value="<?php echo e(request('q')); ?>" placeholder="Search products..." style="width: 100%; padding: 8px 12px 8px 36px; border-radius: 20px; border: 1px solid #e0e0e0; background: #f5f5f5; font-size: 13px;" />
                </form>
            </div>
            ...
            <div class="ud-header-right">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="ud-header-actions" style="margin: 0; gap: 8px;">
                        ...
                        <a href="<?php echo e(route('wishlist.index')); ?>" class="ud-icon-btn hide-on-mobile" aria-label="Wishlist" style="text-decoration:none;">
    ...
    <footer class="site-footer">
        <div class="footer-inner">
            <div class="footer-col footer-brand">
                <a href="<?php echo e(route('shop')); ?>" class="footer-logo" style="display:flex; align-items:center; gap:0; text-decoration:none;">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Pet Markt-PH" style="max-height:36px; margin-right: -8px;">
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> Pet Markt-PH. All rights reserved.</p>
        </div>
    </footer>
