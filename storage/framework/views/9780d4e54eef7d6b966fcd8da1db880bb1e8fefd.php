    ...
    <div class="rider-layout">
        ...
        <main class="rider-main">
            ...
            <div class="active-delivery-banner">
                <div class="banner-title">🚀 Active Delivery — <?php echo e($activeDelivery->display_id); ?></div>
                ...
                <div class="banner-actions">
                    <a href="<?php echo e(route('rider.active')); ?>" class="btn-rider-white">View Details →</a>
                    <?php if(!$activeDelivery->rider_picked_up_at): ?>
