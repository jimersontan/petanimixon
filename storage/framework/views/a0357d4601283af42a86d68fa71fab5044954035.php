...
<script>
    ...
    function refreshUnreadCount() {
        return notificationApiFetch('<?php echo e(route("notifications.unread")); ?>')
            .then(r => r.json())
            .then(data => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('markAllNotificationsRead').addEventListener('click', function() {
            notificationApiFetch('<?php echo e(route("notifications.mark-all-read")); ?>', {
                method: 'POST',
                body: JSON.stringify({})
            }).then(function() {
                currentPage = 1;
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/user/notifications.blade.php ENDPATH**/ ?>