<aside class="sidebar" id="adminSidebar">
            <nav class="sidebar-nav">
                <!-- Dashboard Link -->
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" data-page="dashboard">
                ...
                <!-- Orders Link -->
                <a href="<?php echo e(route('admin.orders')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.orders') ? 'active' : ''); ?>" data-page="orders">
                ...
                <!-- Products Link -->
                <a href="<?php echo e(route('products.readonly')); ?>" class="nav-item <?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>" data-page="products">
                ...
                <a href="<?php echo e(route('inventory.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('inventory.*') ? 'active' : ''); ?>" data-page="inventory">
                ...
                <!-- Customers Link -->
                <a href="<?php echo e(route('customers.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('customers.*') ? 'active' : ''); ?>" data-page="customers">
                ...
                <!-- Riders Link -->
                <a href="<?php echo e(route('riders.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('riders.*') ? 'active' : ''); ?>" data-page="riders">
                ...
                <!-- Couriers Link -->
                <a href="<?php echo e(route('couriers.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('couriers.*') ? 'active' : ''); ?>" data-page="couriers">
                ...
                <!-- Analytics Link -->
                <a href="<?php echo e(route('analytics.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('analytics.*') ? 'active' : ''); ?>" data-page="analytics">
                ...
                <!-- Reviews Link -->
                <a href="<?php echo e(route('reviews.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('reviews.*') ? 'active' : ''); ?>" data-page="reviews">
                ...
                <!-- Categories Link -->
                <a href="<?php echo e(route('categories.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('categories.*') ? 'active' : ''); ?>" data-page="categories">
                ...
                <!-- Brands Link -->
                <a href="<?php echo e(route('brands.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('brands.*') ? 'active' : ''); ?>" data-page="brands">
                ...
                <!-- Settings Link -->
                <a href="<?php echo e(route('settings.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>" data-page="settings">
                ...
                <!-- Coupons Link -->
                <a href="<?php echo e(route('coupons.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('coupons.*') ? 'active' : ''); ?>" data-page="coupons">
                ...
                <!-- Sellers Link -->
                <a href="<?php echo e(route('sellers.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('sellers.*') ? 'active' : ''); ?>" data-page="sellers">
                ...
                <!-- Q&A Link -->
                <a href="<?php echo e(route('qa.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('qa.*') ? 'active' : ''); ?>" data-page="qa">
                ...
                <!-- Returns Link -->
                <a href="<?php echo e(route('returns.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('returns.*') ? 'active' : ''); ?>" data-page="returns">
        ...
        </aside><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/partials/admin_sidebar.blade.php ENDPATH**/ ?>