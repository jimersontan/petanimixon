    ...
    <div class="register-container">
        <div class="register-header-top">
            <div class="register-logo" style="display:flex; align-items:center; gap:0;">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Pet Markt-PH Logo" style="max-height: 44px; margin-right: -10px;">
...
<?php /**PATH C:\xampp\htdocs\Pet Markt-PH\resources\views/register.blade.php ENDPATH**/ ?>