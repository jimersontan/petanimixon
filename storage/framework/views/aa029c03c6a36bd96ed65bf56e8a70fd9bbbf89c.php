                ...
                <tr>
                    ...
                    <td>
                        <?php if(!empty($brand->logo_path)): ?>
                            <img src="<?php echo e($brand->logo_full_url); ?>" alt="<?php echo e($brand->name); ?> logo" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">
                        <?php else: ?>
                            —
                        <?php endif; ?>
                    </td>
                    ...
                    <td class="col-actions">
                        ...
                        <button type="button" class="action-btn" title="Edit" aria-label="Edit brand"
                            onclick="openBrandModal('edit', {
                                ...
                                logo_path: '<?php echo e($brand->logo_path ? $brand->logo_full_url : ''); ?>'
                            })">
                        ...
                        <?php if($brand->is_active ?? true): ?>
                        <!-- Draft Button (Soft Deactivate) -->
                        <form method="POST" action="<?php echo e(route('brands.draft', $brand->id)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
                        ...
                        <?php else: ?>
                        <!-- Restore Button -->
                        <form method="POST" action="<?php echo e(route('brands.restore', $brand->id)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PATCH'); ?>
                        ...
                        <form method="POST" action="<?php echo e(route('brands.destroy', $brand->id)); ?>" style="display:inline">
                            <?php echo csrf_field(); ?>
...
<!-- Modal Container -->
<div id="brand-modal" class="modal <?php echo e($errors->any() ? 'open' : ''); ?>" style="max-width: 800px; width: 95%;" role="dialog" aria-modal="true" aria-labelledby="brandModalTitle" tabindex="-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/brands_admin.blade.php ENDPATH**/ ?>