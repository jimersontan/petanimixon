            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-actions">
                        <!-- Edit Button -->
                        <a href="<?php echo e(route('categories.edit', $category)); ?>" class="action-btn" title="Edit" aria-label="Edit category">
...
<div class="modal-backdrop <?php echo e($errors->any() ? 'open' : ''); ?>" data-modal-id="add-category-modal"></div>

<!-- Modal Container -->
<div id="add-category-modal" class="modal <?php echo e($errors->any() ? 'open' : ''); ?>" role="dialog" aria-modal="true" aria-labelledby="addCategoryTitle" tabindex="-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/categories_admin.blade.php ENDPATH**/ ?>