        ...
        <form method="GET" action="<?php echo e(route('shop.all')); ?>" id="filterForm">
            ...
            <div class="sidebar-section">
                ...
                <input type="range" class="price-slider" name="price_max"
                    ...
                    value="<?php echo e(request()->input('price_max', 500)); ?>"
                    id="priceSlider" oninput="updatePriceLabel(this.value)">
                <div class="price-range-labels">
                    <span>₱0</span>
                    <span>₱<span id="priceMaxLabel"><?php echo e(request()->input('price_max', 500)); ?></span></span>
                </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="product-card">
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-name" style="min-height: auto; margin-bottom: 4px;"><?php echo e($product->product_name); ?></h3>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\petverse\resources\views/frontend/shop.blade.php ENDPATH**/ ?>