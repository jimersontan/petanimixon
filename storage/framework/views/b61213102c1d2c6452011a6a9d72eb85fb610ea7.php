...
<head>
    ...
    <title>Products - Pet Animixon Rider</title>
            ...
            <div class="rider-products-grid">
                ...
                <div class="rider-product-card">
                    <?php if($product->image_url): ?>
                        <img src="<?php echo e(asset($product->image_url)); ?>" alt="<?php echo e($product->product_name); ?>" style="width:100%; height:140px; object-fit:cover; border-radius:10px; margin-bottom:12px; background:#f1f5f9;">
                    <?php else: ?>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/rider/products.blade.php ENDPATH**/ ?>