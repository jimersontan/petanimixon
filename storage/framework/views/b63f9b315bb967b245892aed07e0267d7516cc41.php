        ...
        <div class="brand-card">
            <div class="brand-logo-wrap">
                <?php if($brand->logo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $brand->logo_path)); ?>" alt="<?php echo e($brand->name); ?>" class="brand-logo-img" onerror="this.onerror=null; this.src='<?php echo e(asset('images/placeholder.png')); ?>'">
                <?php else: ?>
            ...
            <div>
                <div style="background: linear-gradient(135deg, #7fb3a3 0%, #6a9e8f 100%); border-radius: 12px; height: 400px; display: flex; align-items: center; justify-content: center; overflow: hidden;" class="featured-brand-img-wrap">
                    <?php if($featuredBrand->logo_path): ?>
                        <img src="<?php echo e(asset('storage/' . $featuredBrand->logo_path)); ?>" alt="<?php echo e($featuredBrand->name); ?>" style="width: 100%; height: 100%; object-fit: cover;" onerror="this.onerror=null; this.src='<?php echo e(asset('images/placeholder.png')); ?>'">
                    <?php else: ?>
                        <div style="display:flex;align-items:center;justify-content:center;width:100%;height:100%;font-size:48px;font-weight:700;color:white;letter-spacing:2px;"><?php echo e(strtoupper(substr($featuredBrand->name, 0, 2))); ?></div>
                    <?php endif; ?>
                </div>
            </div>
