<aside class="sidebar" id="adminSidebar">
            <nav class="sidebar-nav">
                ...
                <!-- Revenue Link -->
                <a href="<?php echo e(route('revenue.admin')); ?>" class="nav-item <?php echo e(request()->routeIs('revenue.*') ? 'active' : ''); ?>" data-page="revenue">
        ...
        </aside><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/partials/admin_sidebar.blade.php ENDPATH**/ ?>