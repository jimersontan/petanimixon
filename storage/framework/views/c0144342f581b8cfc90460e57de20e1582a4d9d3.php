...
<head>
    ...
    <title>Brands - Pet Animixon Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                <a href="<?php echo e(route('dashboard')); ?>" class="nav-item" data-page="dashboard">
                ...
                <a href="<?php echo e(route('admin.orders')); ?>" class="nav-item" data-page="orders">
                ...
                <a href="<?php echo e(route('products.admin')); ?>" class="nav-item" data-page="products">
                ...
                <a href="<?php echo e(route('customers.admin')); ?>" class="nav-item" data-page="customers">
                ...
                <a href="<?php echo e(route('analytics.admin')); ?>" class="nav-item" data-page="analytics">
                ...
                <a href="<?php echo e(route('reviews.admin')); ?>" class="nav-item" data-page="reviews">
                ...
                <a href="<?php echo e(route('categories.admin')); ?>" class="nav-item" data-page="categories">
                ...
                <a href="<?php echo e(route('brands.admin')); ?>" class="nav-item active" data-page="brands">
                ...
                <a href="<?php echo e(route('revenue.admin')); ?>" class="nav-item" data-page="revenue">
                ...
                <a href="<?php echo e(route('settings.admin')); ?>" class="nav-item" data-page="settings">
                    <span class="nav-icon"><svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M19.14 12.94c.04-.31.06-.63.06-.94 0-.31-.02-.63-.06-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94;l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41;l-.36 2.54c-.59.24-1.13.57-1.62.94;l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61;l2.03 1.58c-.04.31-.06.63-.06.94s.02.63.06.94;l-2.03 1.58c-.18.14-.23.41-.12.61;l1.92 3.32c.12.22.37.29.59.22;l2.39-.96c.5.38 1.03.7 1.62.94;l.36 2.54c.05.24.24.41.48.41;h3.84c.24 0 .44-.17.47-.41;l.36-2.54c.59-.24 1.13-.56 1.62-.94;l2.39.96c.22.08.47 0 .59-.22;l1.92-3.32;c.12-.22.07-.47-.12-.61;l-2.01-1.58zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6;s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6;-1.62 3.6-3.6 3.6z"/></svg></span>
                    <span class="nav-label">Settings</span>
                </a>
                <a href="<?php echo e(route('admin.users')); ?>" class="nav-item" data-page="admin-users">
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views\brands_admin_old.blade.php ENDPATH**/ ?>