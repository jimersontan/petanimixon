<?php $__env->startSection('title', 'My Wishlist - PetMarkt-PH'); ?>
    ...
    <?php else: ?>
        <div class="wl-grid">
            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($item->product): ?>
                <div class="wl-card">
                    <a href="<?php echo e(route('product.show', $item->product->id)); ?>" style="text-decoration: none; color: inherit;">
                        <div class="wl-img-wrap">
                            <img src="<?php echo e($item->product->image_url); ?>" alt="<?php echo e($item->product->product_name); ?>" class="wl-img">
                        </div>
                    </a>
                    <div class="wl-body">
                        <div class="wl-brand"><?php echo e($item->product->brand_name ?: 'PetMarkt-PH'); ?></div>
                        <h4 class="wl-name"><?php echo e($item->product->product_name); ?></h4>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/frontend/wishlist.blade.php ENDPATH**/ ?>