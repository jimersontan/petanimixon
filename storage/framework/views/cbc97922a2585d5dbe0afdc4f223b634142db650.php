<?php $__env->startSection('title', 'Track Order - Pet Markt-PH'); ?>
...
<div class="track-page">
    ...
    <div class="track-card">
        ...
        <div class="eta-panel">
            ...
            <div class="eta-cell">
                ...
                <div class="sub" id="etaMethod"><?php echo e($order->isLocal() ? 'Local Delivery' : 'Courier Shipping'); ?></div>
            </div>
        </div>
    ...
    <div class="track-card">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value status-badge badge-<?php echo e($order->order_status); ?>"><?php echo e($order->status_label); ?></span>
        </div>
        <div class="detail-row">
        ...
        <div class="detail-row">
            ...
            <span class="detail-value"><?php echo e($order->isLocal() ? 'Local Delivery' : 'Courier Shipping'); ?></span>
        </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/frontend/order_tracking.blade.php ENDPATH**/ ?>