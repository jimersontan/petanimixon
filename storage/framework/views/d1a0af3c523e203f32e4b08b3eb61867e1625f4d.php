...
<body class="dashboard-body">
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <form method="post" action="<?php echo e(route('admin.profile.update')); ?>" class="form">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views\admin_profile.blade.php ENDPATH**/ ?>