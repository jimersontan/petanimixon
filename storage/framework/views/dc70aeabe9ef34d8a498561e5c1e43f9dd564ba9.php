            ...
            <div class="content-header">
                <div>
                    ...
                    <p class="admin-role-info">
                        <strong>Account Role:</strong> <span class="role-badge" style="background: #ff6b35; color: white; padding: 4px 12px; border-radius: 4px; font-size: 12px; font-weight: 600; display: inline-block;"><?php echo e(ucwords(str_replace('_', ' ', auth()->user()->adminRole()))); ?></span>
                    </p>
                    <?php endif; ?>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Petverse\petverse\resources\views/dashboard_admin.blade.php ENDPATH**/ ?>