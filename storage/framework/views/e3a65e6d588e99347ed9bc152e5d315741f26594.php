...
<nav class="mob-bottom-nav" id="mobBottomNav" aria-label="Mobile navigation">
    ...
    <a href="<?php echo e(route('shop')); ?>" class="mob-nav-item <?php echo e(request()->routeIs('shop') ? 'active' : ''); ?>" data-tab="home">
    ...
    <a href="<?php echo e(route('categories')); ?>" class="mob-nav-item <?php echo e(request()->routeIs('categories*') ? 'active' : ''); ?>" data-tab="categories">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('shop.all')); ?>" class="mob-nav-item <?php echo e(request()->routeIs('shop.all') ? 'active' : ''); ?>" data-tab="shop">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
            <?php if(request()->routeIs('shop.all')): ?>
...
<div class="mob-auth-sheet" id="mobAuthSheet">
    ...
    <a href="<?php echo e(route('login')); ?>" class="mob-auth-sheet-login">Sign In</a>
    <button class="mob-auth-sheet-dismiss" onclick="hideAuthSheet()">Continue browsing</button>
</div>
<?php endif; ?>
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/frontend/partials/mobile-bottom-nav.blade.php ENDPATH**/ ?>