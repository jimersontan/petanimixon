                ...
                <form id="adminLoginForm" method="POST" action="<?php echo e(route('admin.login.submit')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="text" id="admin_email" name="email" placeholder="admin@petmrkt.com" class="form-control" required>
                        </div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/admin_login.blade.php ENDPATH**/ ?>