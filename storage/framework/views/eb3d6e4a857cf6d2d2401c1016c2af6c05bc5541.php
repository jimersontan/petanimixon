...
<body class="user-dashboard theme-<?php echo e(Auth::check() ? (Auth::user()->color_theme ?? 'citrus_tail') : 'citrus_tail'); ?>">
    <header class="ud-header">
        <div class="ud-header-inner">
            <a href="<?php echo e(route('shop')); ?>" class="ud-logo" style="display:flex; align-items:center; gap:0; text-decoration:none;">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="PetMarkt-PH Logo" style="max-height: 38px; margin-right: -8px;">
    ...
    <footer class="site-footer">
        <div class="footer-inner">
            <div class="footer-col footer-brand">
                <a href="<?php echo e(route('shop')); ?>" class="footer-logo" style="display:flex; align-items:center; gap:0; text-decoration:none;">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="PetMarkt-PH" style="max-height:36px; margin-right: -8px;">
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> PetMarkt-PH. All rights reserved.</p>
        </div>
    </footer>
