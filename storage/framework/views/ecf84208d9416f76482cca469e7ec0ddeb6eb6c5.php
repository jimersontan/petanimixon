...
<div class="form-two-panel">
    ...
    <div class="form-panel-left">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" rows="5" placeholder="Brief description of this category"><?php echo e(old('description', $category->description)); ?></textarea>
        </div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/categories/_form.blade.php ENDPATH**/ ?>