...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> - PetMarkt-PH Admin</title>
    ...
    <header class="dashboard-header">
        ...
        <div class="header-left">
            <div class="logo" style="display:flex; align-items:center; gap:0;">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo" style="max-height: 28px; margin-right: -6px;">
                <span class="logo-text" style="margin:0; color:#1f2937;">Pet <span style="color: #ea580c;">Markt-PH</span></span>
            </div>
        </div>
        <!-- End: Logo -->
