<?php
    ...
    $user = auth()->user();
    $isMainAdmin = $user && method_exists($user, 'isMainAdmin') && $user->isMainAdmin();
    $isSupervisor = $user && method_exists($user, 'isSupervisor') && $user->isSupervisor();
    $isStaffAdmin = $user && method_exists($user, 'isStaffAdmin') && $user->isStaffAdmin();
?>
<aside class="sidebar">
    <nav class="sidebar-nav">
        <a href="<?php echo e(route('dashboard')); ?>" class="nav-item <?php echo e($current==='dashboard' ? 'active':''); ?>" data-page="dashboard">
        ...
        <a href="<?php echo e(route('admin.orders')); ?>" class="nav-item <?php echo e($current==='admin.orders' ? 'active':''); ?>" data-page="orders">
        ...
        <a href="<?php echo e(route('products.admin')); ?>" class="nav-item <?php echo e($current==='products.admin' ? 'active':''); ?>" data-page="products">
        ...
        <a href="<?php echo e(route('inventory.admin')); ?>" class="nav-item <?php echo e($current==='inventory.admin' ? 'active':''); ?>" data-page="inventory">
            <span class="nav-icon"><svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49c.08-.14.12-.31.12-.48 0-.55-.45-1-1-1H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/></svg></span>
        ...
        <?php if($isMainAdmin): ?>
        <a href="<?php echo e(route('customers.admin')); ?>" class="nav-item <?php echo e($current==='customers.admin' ? 'active':''); ?>" data-page="customers">
        ...
        <?php if($isSupervisor): ?>
        <a href="<?php echo e(route('analytics.admin')); ?>" class="nav-item <?php echo e($current==='analytics.admin' ? 'active':''); ?>" data-page="analytics">
        ...
        <a href="<?php echo e(route('reviews.admin')); ?>" class="nav-item <?php echo e($current==='reviews.admin' ? 'active':''); ?>" data-page="reviews">
        ...
        <?php if($isSupervisor): ?>
        <a href="<?php echo e(route('categories.admin')); ?>" class="nav-item <?php echo e($current==='categories.admin' ? 'active':''); ?>" data-page="categories">
        ...
        <?php if($isSupervisor): ?>
        <a href="<?php echo e(route('brands.admin')); ?>" class="nav-item <?php echo e($current==='brands.admin' ? 'active':''); ?>" data-page="brands">
        ...
        <?php if($isMainAdmin): ?>
        <a href="<?php echo e(route('revenue.admin')); ?>" class="nav-item <?php echo e($current==='revenue.admin' ? 'active':''); ?>" data-page="revenue">
        ...
        <?php if($isMainAdmin): ?>
        <a href="<?php echo e(route('settings.admin')); ?>" class="nav-item <?php echo e($current==='settings.admin' ? 'active':''); ?>" data-page="settings">
        ...
        <?php if($isSupervisor): ?>
        <a href="<?php echo e(route('admin.users')); ?>" class="nav-item <?php echo e($current==='admin.users' ? 'active':''); ?>" data-page="admin-users">
        ...
        <?php if($isMainAdmin): ?>
        <a href="<?php echo e(route('admin.requests')); ?>" class="nav-item <?php echo e($current==='admin.requests' ? 'active':''); ?>" data-page="admin-requests">
            <span class="nav-icon"><svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h9l7-7V5c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V7h2v4z"/></svg></span>
            <span class="nav-label">Admin Requests</span>
        </a>
        <?php endif; ?>
    </nav>

    <!-- Inventory Module Widget -->
    <?php if($isAdmin ?? false): ?>
        <div class="sidebar-widget">
            <?php echo $__env->make('components.inventory-sidebar', [
                'totalProducts' => $stats['total_products'] ?? 0,
                'activeProducts' => $stats['active_products'] ?? 0,
                'lowStockItems' => $stats['low_stock'] ?? 0,
                'products' => $sidebarProducts ?? []
            ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    <?php endif; ?>
</aside><?php /**PATH C:\xampp\htdocs\Petverse\petverse\resources\views/partials/admin_sidebar.blade.php ENDPATH**/ ?>