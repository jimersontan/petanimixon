        ...
        <div class="login-left gradient-orange">
            <div class="left-content">
                <div class="brand-logo" style="display:flex; align-items:center; gap:14px;">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="PetMarkt-PH Logo" style="max-height: 64px;">
                ...
                <div class="illustration-box">
                    <div class="pet-illustration">
                        <img src="<?php echo e(asset('images/login_pets.png')); ?>" alt="Pets">
                    </div>
                </div>
            </div>
        </div>
                ...
                <form method="POST" action="<?php echo e(route('password.email')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="email" id="email" name="email" placeholder="your@email.com" class="form-control" required value="<?php echo e(old('email')); ?>">
                        </div>
                    </div>
...
<?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\petanimixon\resources\views/auth/password_request.blade.php ENDPATH**/ ?>