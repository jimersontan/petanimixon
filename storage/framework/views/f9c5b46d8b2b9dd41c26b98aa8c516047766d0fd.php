                ...
                <div class="store-info-grid">
                    ...
                    <div class="grid-column">
                        <div class="form-group">
                            ...
                            <input type="text" id="store_name" name="store_name" class="settings-input" value="<?php echo e(old('store_name', $s->store_name ?? '')); ?>" placeholder="e.g. PetMarkt-PH">
                        </div>
        ...
        <section class="settings-panel" id="panel-email-templates">
            ...
            <form method="post" action="<?php echo e(route('settings.admin.update')); ?>" id="form-email-templates">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="email_from_name" class="settings-input" value="<?php echo e($extra['email_from_name'] ?? ($s->store_name ?? 'PetMarkt-PH')); ?>">
                </div>
