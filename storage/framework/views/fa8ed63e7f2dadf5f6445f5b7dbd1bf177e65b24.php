                                    ...
                                    <td>
                                        <div style="display:flex; align-items:center; gap:10px;">
                                            <?php if(optional($item->product)->animal_image_url): ?>
                                                <img src="<?php echo e(asset('storage/'.optional($item->product)->animal_image_url)); ?>" style="width:36px; height:36px; border-radius:6px; object-fit:cover;">
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?>
                                            <div style="font-weight: 500; color:#1f2937;"><?php echo e(optional($item->product)->product_name ?? 'Unknown'); ?></div>
                                        </div>
                                    </td>
                                    <td><?php echo e(number_format($item->total_sold)); ?></td>
                                    <td style="font-weight: 600;">₱<?php echo e(number_format($item->total_revenue, 2)); ?></td>
                                </tr>
                    ...
                    <div class="table-wrap">
                        <table class="orders-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div style="font-weight: 500; color:#1f2937;"><?php echo e($order->user ? trim($order->user->first_name . ' ' . $order->user->last_name) : 'Guest'); ?></div>
                                        <div style="font-size: 12px; color: #6b7280;">#<?php echo e($order->id); ?></div>
                                    </td>
                                    <td><?php echo e($order->created_at->format('M j, Y')); ?></td>
                                    <td style="font-weight: 600; color:#059669;">₱<?php echo e(number_format((float) $order->total_amount, 2)); ?></td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Category Chart Data
            const catLabels = <?php echo json_encode(collect($salesByCategory ?? [])->pluck('category_name')); ?>;
            const catData = <?php echo json_encode(collect($salesByCategory ?? [])->pluck('total_revenue')); ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\John Carry\.gemini\antigravity\scratch\Pet Markt-PH\resources\views/analytics_admin.blade.php ENDPATH**/ ?>